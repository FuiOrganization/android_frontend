...
public class CustomSharedPreferences {
    ...
    public static void updateHistory(ArrayList<Checkin> history){
    ...
    public static ArrayList<Checkin> getHistory(){
        Gson gson = new Gson();
        String json = CustomSharedPreferences.settings.getString(HISTORY,"");
        ArrayList<Checkin> obj = gson.fromJson(json, new TypeToken<ArrayList<Checkin>>(){}.getType());
        return obj;
    }
